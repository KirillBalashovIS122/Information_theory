...
from entr import encode_file, decode_file, calculate_compression_ratio
...
class HuffmanApp:
    ...
    def create_widgets(self):
        ...
        tk.Radiobutton(frame, text="Encode", variable=self.mode, value="encode").pack(side=tk.LEFT, padx=10)
        tk.Radiobutton(frame, text="Decode", variable=self.mode, value="decode").pack(side=tk.LEFT, padx=10)
